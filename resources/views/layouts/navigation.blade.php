    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="block h-20 w-auto rounded-lg fill-current text-gray-800" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <!-- Notification Icon -->
                <div class="relative">
                    <button id="notification-toggle" class="btn btn-ghost btn-circle relative px-3 py-2 bg-white">
                        <div class="indicator">
                            <svg
                            ...
                            <span class="indicator-item badge badge-xs bg-red-600 text-white font-bold w-4 h-4">
