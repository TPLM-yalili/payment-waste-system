        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md sm:rounded-lg overflow-hidden">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="mt-2 text-lg text-gray-700">Jumlah: Rp {{ number_format($invoice->amount, 2, ',', '.') }}
                    </p>
                    <p class="mt-2 text-gray-500">Silakan bayar tagihan Anda dengan tombol di bawah.</p>

                    <!-- Tombol untuk memulai pembayaran -->
                    <button id="pay-button"
                        class="mt-6 w-full sm:w-auto px-6 py-3 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition-colors">
                        Bayar Sekarang
                    </button>
                </div>
            </div>
